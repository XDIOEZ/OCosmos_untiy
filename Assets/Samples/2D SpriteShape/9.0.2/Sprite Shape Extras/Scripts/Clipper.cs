...
namespace ExtrasClipperLib
{
    ...
    internal class Clipper : ClipperBase
    {
                ...
                else
                {
                    ...
                    if (StrictlySimple)
                    {
                            ...
                            (ePrev.WindDelta != 0))
                        {
                            ...
                            AddJoin(op, op2, ip); //StrictlySimple (_type-3) join
                        }
                    }
        ...
        public static int PointInPolygon(IntPoint pt, Path path)
        {
            ...
            //http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.88.5498&rep=rep1&_type=pdf
    ...
    internal class ClipperOffset
    {
        ...
        public void AddPath(Path path, JoinType joinType, EndType endType)
        {
            ...
            //strip duplicate points from path and also get CurrentIndex to the lowest point ...
